...
class oo extends y {
  ...
  async renderFromHTML(e) {
    await this.Editor.BlockManager.clear(), await this.Editor.Paste.processText(e, !0);
  }
  /**
    ...
    return await new Promise((r, a) => {
      try {
        window.requestIdleCallback(() => {
          i.call(X.ON_PASTE, t), r(i);
        });
      } catch (l) {
        T(`${e}: onPaste callback call is failed`, "error", l), a(l);
      }
    });
  }
  /**
...
const Bt = class extends y {
  ...
  async processText(n, e = !1) {
    ...
    if (!i.length)
      return;
    if (i.length === 1) {
      i[0].isBlock ? await this.processSingleBlock(i.pop()) : await this.processInlinePaste(i.pop());
      return;
    }
    const r = o.currentBlock && o.currentBlock.tool.isDefault && o.currentBlock.isEmpty;
    await Promise.all(
      i.map(
        (a, l) => this.insertBlock(a, l === 0 && r)
      )
  ...
  async processSingleBlock(n) {
    ...
    if (!o || n.tool !== o.name || !c.containsOnlyInlineElements(n.content.innerHTML)) {
      await this.insertBlock(n, (o == null ? void 0 : o.tool.isDefault) && o.isEmpty);
      return;
    }
  ...
  async processInlinePaste(n) {
    ...
    if (e.currentBlock && e.currentBlock.tool.isDefault && o.textContent.length < Bt.PATTERN_PROCESSING_MAX_LENGTH) {
      ...
      if (s) {
        const r = e.currentBlock && e.currentBlock.tool.isDefault && e.currentBlock.isEmpty, a = await e.paste(s.tool, s.event, r);
   ...
   * @returns {void}
   */
  async insertBlock(n, e = !1) {
    const { BlockManager: t, Caret: o } = this.Editor, { currentBlock: i } = t;
    let s;
    if (e && i && i.isEmpty) {
      s = await t.paste(n.tool, n.event, !0), o.setToBlock(s, o.positions.END);
      return;
    }
    s = await t.paste(n.tool, n.event), o.setToBlock(s, o.positions.END);
  }
  /**
